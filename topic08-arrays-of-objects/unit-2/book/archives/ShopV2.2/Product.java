/**
 * Product class with validation implemented
 *
...
public class Product {
    ...
    private String productName = "";  //max length = 20 chars

    private int productCode = 5000;   //valid product codes between 1000 and 5000

    private double unitCost = 0.0;    // cost must be >=0
