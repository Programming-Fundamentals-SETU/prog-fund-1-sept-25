...
During this challenge, you may need to view this weeks and last weeks lecture notes to remind you how to write classes.  The SpotConsoleV1.0 (particularly for validation) and the ShopV1.0 solution will also come in handy here.

- In BlueJ, create a new  Project called **GymApp1.0**.
...
- **height** is between 0 and 3.0 inclusive
- **weight** is 0 and 600 inclusive
...
Write a method called **printGymMember()** that prints all the **gymMember* details to the console.  Hint: use the toString() method from the GymMember class.

Write a **main** method that calls the Driver() constructor.

Writye a **Driver()** constructor that calls both the **addGymMember()** and **printGymMember()** methods. 
