...
Write a method that returns the the position of thelargest value in an array of integers. (you can assume that the array is not empty, and that it is fully  populated with values) 
