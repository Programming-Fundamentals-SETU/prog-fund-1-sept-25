...
\begin{itemize}
    ...
    \ \href{https://join.slack.com/t/progfund2025-2026/shared_invite/zt-3ck6bblib-GPEEFtkNPF0R5Cxoj4wZAQ}{here}. 
    We  will be using this a main form of 'outside class' communication for this module. 
    If you have a general query, please use the \textbf{\#all-prog-fund-2025-2026} channel. 
    ...
    and/or \item \href{mailto:mairead.meagher@setu.ie}{mairead.meagher@setu.ie}. 
...
where you can find links to the notes, and where online exams are curated. The link to this course is \href{https://tutors.dev/course/prog-fund-1-sept-2025}{here}.  
...
\href{https://moodle.setu.ie/course/view.php?id=215012}{here}.  \\
Each week there will be a set of links made available to you for that week  see Figure \ref{moodleWeek} for example including: 
\begin{itemize}
    \item Links to topics in the tutors website,
    \item Links to 'dropboxes' for the labs and/or exercises for that week,
    \item Checklist of activities to be done before the next week. See Figure \ref{checklist} for example. This should be filled in each 
    week to help you keep track of your progress.
\end{itemize}

\begin{figure}[h]
\centering
\includegraphics[width=.6\textwidth]{img/week-to-do.png}
\caption{Weekly activities on Moodle}
\label{moodleWeek}
\end{figure}
\begin{figure}[h]
\centering
\includegraphics[width=.6\textwidth]{img/checkList.png}
\caption{Weekly Checklist example}
\label{checklist}
\end{figure}
...
Your module assessment  is made up of:  
    \begin{itemize}
        \item \textbf{Attendance at tutorials (10) - 10\%.} You are  asked to attend your tutorials where written problem sheets will be given and so that you can practice any new concepts. The 
        ...
        \item   You will be asked to solve a problem using classes, methods and arrays. The problem will be fully specified and you will be asked to implement it in \textbf{\textit{Java}} using the \textit{BlueJ} environment

        Having practiced the material in the first half of the module, you will be asked to complete a programming assignment which uses the material covered in the first half of the 
        module and the new material covered in the second half of the module. Also, in the case of this programming assignment, you will be asked 
to sit an in-class test based around your assignment. This is to help us during our interview process for this assignment. You may be asked to attend an interview with one of the lecturers to discuss your assignment.
If you have been asked to but  do not attend the interview, you will not get any marks for the assignment.
  ...
  \begin{table}
    \begin{center}
        \begin{tabular}{|c|c|c|c|}
            ...
            \rowcolor{red!60}
            \textbf{Type} & Test & Assignment &  attendance \\
    

            \hline
            \rowcolor{red!30}
            \textbf{Week No.} & Week 7 & Week 12 & each Week \\
            \hline
            \rowcolor{red!30}
            \textbf{Time of test/} & Monday  & 18:00,  & n/a \\
            \rowcolor{red!30}
            
            \textbf{Time /Deadline} & lecture time& Sunday 8th Dec.& \\
            \hline
            \rowcolor{red!35}
            \textbf{Written exam} & during lectures & Monday 7th Dec. & n/a \\
            \hline
            \rowcolor{red!40}
...
\subsection{Assessment Feedback}
...
\subsection{Notes on Programming Assignment}
...
\pagebreak
\section{Organisation and Study Skills}
...
\end{center}
\end{table}
A video on how to do this is \href{https://tutors.dev/video/prog-fund-1-sept-2025/topic00-induction/side-unit/talk-2/oQEves88Phk}{here}.
\subsection{Bookmarks in your browser}
You will be using a lot of online resources during your time in college.
It is a good idea to set up a bookmarks or bookmark folders in your browser.
This will save you a lot of time in the long run. A video on how to do this is \href{hhttps://tutors.dev/video/prog-fund-1-sept-2025/topic00-induction/side-unit/talk-1/WdLsvGJ5z38}{here}.
