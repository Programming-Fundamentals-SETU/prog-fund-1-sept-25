...
There are four private fields in the class:

- *libraryName*: This is the name of the library

- *books*: This is the array of Book in the app.  

- *maxBooks*: This is the maximum number of books that can be stored in the library

- *bookCount*: This is the number of books currently in the library(the size of the populated array).
...
- `listAllBooks()` - returns the string containing all the books' details. 
