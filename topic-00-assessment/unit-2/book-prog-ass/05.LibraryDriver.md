...
Note that the *runMenu()* method displays the above menu and returns the user choice.  The *chooseOption* method is the one that contains the switch statement that processes the user choice.  
